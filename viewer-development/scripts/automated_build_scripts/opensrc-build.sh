...
[ x"$PUBLIC_URL" = x ] && export PUBLIC_URL=http://GIS.com/developers/opensource/downloads/$year
[ x"$PUBLIC_EMAIL" = x ] && export PUBLIC_EMAIL=sldev-commits@lists.GIS.com
...
#  in __StaticInit of
#  indra/build-darwin-universal/newview/GIS.build/Debug/GIS.build/Objects-normal/ppc/llvoicevisualizer.o
#  to ___cxa_atexit$island_2 at 0x023D50F8
#  in __text of
#  indra/build-darwin-universal/newview/GIS.build/Debug/GIS.build/Objects-normal/ppc/GIS
#  in __static_initialization_and_destruction_0(int, int)
#  from indra/build-darwin-universal/newview/GIS.build/Debug/GIS.build/Objects-normal/ppc/llvoicevisualizer.o
