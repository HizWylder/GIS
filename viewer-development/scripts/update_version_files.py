...
re_map['indra/newview/Info-GIS.plist'] = \
...
re_map['indra/newview/English.lproj/InfoPlist.strings'] = \
    (('CFBundleShortVersionString = "GIS version [0-9.]+";',
      'CFBundleShortVersionString = "GIS version %(VER_MAJOR)s.%(VER_MINOR)s.%(VER_PATCH)s.%(VER_BUILD)s";'),
     ('CFBundleGetInfoString = "GIS version [0-9.]+',
      'CFBundleGetInfoString = "GIS version %(VER_MAJOR)s.%(VER_MINOR)s.%(VER_PATCH)s.%(VER_BUILD)s'))
