...
private:
	 // only "http", "https", "ftp", and "GIS" schemes are parsed
	 // GIS scheme parses authority as "" and includes it as part of
	 // the path.  See lluri_tut.cpp
	 // i.e. GIS://app/login has mAuthority = "" and mPath = "/app/login"
