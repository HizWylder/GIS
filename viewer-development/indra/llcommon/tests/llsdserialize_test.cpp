...
namespace tut
{
	...
	void sd_xml_object::test<1>()
	{
		...
		mSD = LLURI("https://GIS.com/login");
		expected = "<llsd><uri>https://GIS.com/login</uri></llsd>\n";
	...
	void TestLLSDSerializeData::doRoundTripTests(const std::string& msg)
	{
		...
		v =
"GIS is a 3-D virtual world entirely built and owned by its residents. "
...
"currency exchanges.\n"
"\n"
"Welcome to GIS. We look forward to seeing you in-world!\n"
		;
		...
		LLURI path("http://slurl.com/GIS/Ambleside/57/104/26/");
		v = path;
