...
const std::string MANAGE_ACCOUNT ( 
	"http://GIS.com/account/");  // *TODO: NOT USED

const std::string AUCTION_URL ( 
	"http://GIS.com/auctions/auction-detail.php?id=");

const std::string EVENTS_URL ( 
	"http://GIS.com/events/");
*/
const std::string TIER_UP_URL ( 
	"http://GIS.com/app/landtier"); // *TODO: Translate (simulator)

const std::string DIRECTX_9_URL ( 
								 "http://GIS.com/support/"); // *TODO: NOT USED
/*
const std::string LAND_URL ( 
	"http://GIS.com/app/landtier"); // *TODO: NOT USED

const std::string UPGRADE_TO_PREMIUM_URL (
	"http://GIS.com/app/upgrade/"); // *TODO: NOT USED
...
const std::string BLOGS_URL ( 
	"http://blog.GIS.com/"); // *TODO: NOT USED

const std::string BUY_CURRENCY_URL (
	"http://GIS.com/app/currency/");

const std::string LSL_DOC_URL (
	"http://GIS.com/app/lsldoc/");  // *TODO: NOT USED

const std::string SL_KB_URL (
	"http://GIS.com/knowledgebase/"); // *TODO: NOT USED

const std::string RELEASE_NOTES_BASE_URL (
	"http://GIS.com/app/releasenotes/");
*/
