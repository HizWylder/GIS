...
// mMessage.setArg("[SECONDLIFE]", "GIS");
// llinfos << mMessage.getString() << llendl; // outputs "Welcome Steve to GIS"
// mMessage.setArg("[USERNAME]", "Joe");
// llinfos << mMessage.getString() << llendl; // outputs "Welcome Joe to GIS"
