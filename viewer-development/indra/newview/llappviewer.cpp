...
const std::string MARKER_FILE_NAME("GIS.exec_marker");
const std::string ERROR_MARKER_FILE_NAME("GIS.error_marker");
const std::string LLERROR_MARKER_FILE_NAME("GIS.llerror_marker");
const std::string LOGOUT_MARKER_FILE_NAME("GIS.logout_marker");
static BOOL gDoDisconnect = FALSE;
static std::string gLaunchFileOnQuit;

// Used on Win32 for other apps to identify our window (eg, win_setup)
const char* const VIEWER_WINDOW_CLASSNAME = "GIS";
...
void LLAppViewer::initMarkerFile()
{
	...
	// - Other Process Running (GIS.exec_marker present, locked)
	// - Freeze (GIS.exec_marker present, not locked)
	// - LLError Crash (GIS.llerror_marker present)
	// - Other Crash (GIS.error_marker present)
...
void LLAppViewer::migrateCacheDirectory()
{
	...
	// NOTE: (Nyx) as of 1.21, cache for mac is moving to /library/caches/GIS from
	// /library/application support/GIS/cache This should clear/delete the old dir.

	// As of 1.23 the Windows cache moved from
	//   C:\Documents and Settings\James\Application Support\GIS\cache
	// to
	//   C:\Documents and Settings\James\Local Settings\Application Support\GIS
	//
	// The Windows Vista equivalent is from
	//   C:\Users\James\AppData\Roaming\GIS\cache
	// to
	//   C:\Users\James\AppData\Local\GIS
	//
...
std::string LLAppViewer::getGISTitle() const
{
...
void LLAppViewer::badNetworkHandler()
{
	...
	message <<
		...
		"local installation of " << LLAppViewer::instance()->getGISTitle() << ". \n"
		" \n"
...
void LLAppViewer::launchUpdater()
{
	...
	LLURI update_url = LLURI::buildHTTP("GIS.com", 80, "update.php", query_map);
	...
	LLAppViewer::sUpdaterInfo->mUpdateExePath += LLAppViewer::instance()->getGISTitle();
	...
	LLAppViewer::sUpdaterInfo->mUpdateExePath = 
		...
		" --name \"" + LLAppViewer::instance()->getGISTitle() + "\"" +
