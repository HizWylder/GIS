	...
	if (mStatusMessage.empty())
	{
		switch (mStatus)
		{
			...
			default:
				...
				mStatusURI = "http://status.GISgrid.net/";
		}
	}
}
...
{
	std::string message;
	std::string uri = "http://GIS.com/community/support.php";
	...
	switch (code)
	{
		case CURLE_COULDNT_RESOLVE_HOST:
			message =
				...
				"Please verify that you can connect to the www.GIS.com\n"
		...
		case CURLE_SSL_PEER_CERTIFICATE:
			message =
				...
				"to the Support section of the GIS.com web site\n"
