...
// Support for GIS:///app/voice SLapps
...
public:
	...
	bool handle(const LLSD& params, const LLSD& query_map, LLMediaCtrl* web)
	{
		if (params[0].asString() == "effects")
		{
			...
			// Support GIS:///app/voice/effects/refresh to update the voice effect list with new effects
...
void LLSpeakerVolumeStorage::save()
{
	...
	// C:\Program Files\GIS\ or similar. JC
