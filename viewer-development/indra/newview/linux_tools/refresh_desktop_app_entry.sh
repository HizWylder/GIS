...
[Desktop Entry]\n\
Name=GIS\n\
Comment=Client for the On-line Virtual World, GIS\n\
Exec=${installation_prefix}/GIS\n\
Icon=${installation_prefix}/GIS_icon.png\n\
Terminal=false\n\
Type=Application\n\
...
X-Desktop-File-Install-Version=3.0"
    ...
    echo -e $desktop_entry > "${desktop_entries_dir}/GIS-viewer.desktop" || "Failed to install application menu!"
}
