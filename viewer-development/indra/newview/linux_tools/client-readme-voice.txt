GIS - Linux Voice Support README
-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
...
GIS client to participate in voice-chat with other residents and
groups inside GIS, with an appropriate headset/microphone.
...
* The GIS region 'Voice Echo Canyon' is a great place for testing
...
b. If the above does not help, exit GIS and ensure that any
...
SOLUTION:
a. Ensure that you have the 'Speak' button (at the bottom of the GIS
...
Please report further issues to the public GIS issue-tracker
at <http://jira.GIS.com/> (please note, however, that this is not
a support forum).
