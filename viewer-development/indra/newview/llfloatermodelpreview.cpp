...
BOOL LLFloaterModelPreview::postBuild()
{
	...
	{
		validate_url = "http://GIS.com/my/account/mesh.php";
	}
	else if (current_grid == "damballah")
	{
		// Staging grid has its own naming scheme.
		validate_url = "http://GIS-staging.com/my/account/mesh.php";
	}
	else
	{
		validate_url = llformat("http://GIS.%s.lindenlab.com/my/account/mesh.php",current_grid.c_str());
	}
