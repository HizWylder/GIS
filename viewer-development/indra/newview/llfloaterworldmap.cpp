...
// handle GIS:///app/worldmap/{NAME}/{COORDS} URLs
...
public:
				...
				LLMediaCtrl* web)
	{
		...
		if (params.size() == 0)
		{
			// support the GIS:///app/worldmap SLapp
			LLFloaterReg::showInstance("world_map", "center");
			return true;
		}
		
		// support the GIS:///app/worldmap/{LOCATION}/{COORDS} SLapp
...
// SocialMap handler GIS:///app/maptrackavatar/id
