...
namespace tut
{
	...
	void viewerhelputil_object_t::test<1>()
	{
		...
		gHelpURL = "http://GIS.com/[LANGUAGE]";
		gLanguage = "Gaelic";
		subresult = LLViewerHelpUtil::buildHelpURL(topic);
		ensure_equals("simple substitution with url", subresult, "http://GIS.com/Gaelic");
		...
		gGrid = "mysim";
		subresult = LLViewerHelpUtil::buildHelpURL(topic);
		ensure_equals("complex substitution", subresult, "http://GIS Test/2.0/gaelic/AmigaOS 2.1/mysim/[XXX]");
	}
}
