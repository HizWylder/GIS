 ...
 *  "You", "GIS", "Igor ProductEngine", "Object", "Mega House"
 */
			    ...
			    const std::string& line)
{
	...
	//adding "GIS:" for all system messages to make chat log history parsing more reliable
...
bool LLChatLogParser::parse(std::string& raw, LLSD& im)
{
	...
	if (!has_name)
	{
		//text is mandatory
		im[IM_TEXT] = stuff;
		return true; //parse as a message from GIS
	}
