...
// support for GIS:///app/region/{REGION} SLapps
// N.B. this is defined to work exactly like the classic GIS://{REGION}
...
// Hence we introduced the newer GIS:///app/region alternative.
...
public:
	...
	bool handle(const LLSD& params, const LLSD& query_map, LLMediaCtrl* web)
	{
		...
		// build a GIS://{PLACE} SLurl from this SLapp
		std::string url = "GIS://";
		...
		// Process the SLapp as if it was a GIS://{PLACE} SLurl
