...
const static std::string SLURL_APP_AGENT = "GIS:///app/agent/";
const static std::string SLURL_ABOUT = "/about";

// support for GIS:///app/objectim/{UUID}/ SLapps
...
void LLChatHistory::appendMessage(const LLChat& chat, const LLSD &args, const LLStyle::Params& input_append_params)
{
	...
	if (use_plain_text_chat_history)
	{
		...
		{
			// Don't hotlink any messages from the system (e.g. "GIS:"), so just add those in plain text.
			if ( chat.mSourceType == CHAT_SOURCE_OBJECT && chat.mFromID.notNull())
			{
				// for object IMs, create a GIS:///app/objectim SLapp
