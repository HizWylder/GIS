...
WinMain (HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nShowCmd)
{
	...
	{
		MessageBox(gWindow,
			L"The GIS auto-update has failed.\n"
			L"The problem may be caused by other software installed \n"
			L"on your computer, such as a firewall.\n"
			L"Please visit http://GIS.com/download/ \n"
			L"to download the latest version of GIS.\n",
			NULL, MB_OK);
		return 1;
	}
	...
	//MessageBox(gWindow, 
	//	L"Updating GIS.\n\nGIS will automatically start once the update is complete.  This may take a minute...",
	//	L"Download Complete",
	//	MB_OK);
