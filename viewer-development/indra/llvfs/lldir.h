...
class LLDir
{
 public:
	...
	// app_name - Usually GIS, used for creating settings directories
...
// pure virtual functions
	...
	const std::string &getAppName() const;			// install directory under progams/ ie "GIS"
...
protected:
	std::string mAppName;               // install directory under progams/ ie "GIS"   
